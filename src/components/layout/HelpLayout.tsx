...
export const HelpLayout = () => {
  return (
    <div className="legacy-dark-scope min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      {/* HEADER */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to={ROUTES.root} className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <div className="text-[10px] uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 font-bold">Support Center</div>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Link to={ROUTES.auth.login} className="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-100 transition-colors">Đăng nhập</Link>
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
          <div className="col-span-2 md:col-span-1 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-400 dark:text-slate-500 uppercase tracking-[0.2em] font-bold">Help Center</div>
              </div>
            </div>
          ...
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Tài liệu</div>
          ...
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Hỗ trợ</div>
            <ul className="space-y-2 text-slate-600 dark:text-slate-300">
          ...
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Pháp lý</div>
            <ul className="space-y-2 text-slate-600 dark:text-slate-300">
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 py-6">
          <div className="max-w-7xl mx-auto px-4 text-center text-xs font-bold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">
